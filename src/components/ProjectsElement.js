    ...
    return (
        <div className="projectElementsDiv elementStyle">
            <div className="projectElementsDiv--imgDiv">
                <img
                    className="projectElementsDiv--img"
                    alt="projectImg"
                    src={
                        currentImg &&
                        require(`../resources/project-images/${currentImg}`)
                    }
                ></img>
            </div>
            ...
            <div className="projectElementsDiv--info">
                ...
                <div className="projectElementsDiv__info--buttonsDiv">
                    <a
                        className="projectElementsDiv__info__buttonsDiv-aElement"
                        target="_blank"
                        rel="noopener noreferrer"
                        href={props.array.website}
                    >
                        Demo
                    </a>
                    <a
